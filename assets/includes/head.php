...
<head>
  ...
  grunticon(["<?php echo $assets?>/css/icons.data.svg.css?v=<?php echo $cssVersion?>", "<?php echo $assets?>/css/icons.data.png.css?v=<?php echo $cssVersion?>", "<?php echo $assets?>/css/icons.fallback.css?v=<?php echo $cssVersion?>"]);

  </script>
  <noscript><link href="<?php echo $assets?>/css/icons.fallback.css?v=<?php echo $cssVersion?>" rel="stylesheet"></noscript>
