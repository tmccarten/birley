...
<head>
  ...
  grunticon(["<?php echo $assets?>/css/icons.data.svg.css?v=8", "<?php echo $assets?>/css/icons.data.png.css?v=8", "<?php echo $assets?>/css/icons.fallback.css?v=8"]);

  </script>
  <noscript><link href="<?php echo $assets?>/css/icons.fallback.css?v=8" rel="stylesheet"></noscript>
