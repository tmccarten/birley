      ...
      <nav class="main-nav">
        <ul class="main-nav__items">
          ...
          <li class="main-nav__item parent-item">
            ...
            <a href="javascript:;" <?php if ($activePage === "Health") {echo 'class="main-nav__link main-nav__link--health current parent"'; }?> class="main-nav__link main-nav__link--health parent">
          ...
          <li class="main-nav__item parent-item">
            ...
            <ul class="sub-menu">
              ...
              <li class="sub-menu__item"><a href="<?php echo $linkArchive?>artwork.php" <?php if ($activeSubPage === "Artwork") { echo 'class="sub-menu__link sub-menu__link--current"'; }?> class="sub-menu__link">Artwork</a></li>
