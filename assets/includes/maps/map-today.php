<div class="map__inner">
  ...
  <div id="icon" class="icon icon__brooks">
    ...
    <div class="icon__brooks--hover">
      ...
      <p>For information on the building and its facilities, including hire and use: <a href="http://mmu.ac.uk/birley">http://mmu.ac.uk/birley</a></p>
    </div>

  </div>

  <div id="icon" class="icon icon__vine">
