      ...
      <nav class="main-nav">
        <ul class="main-nav__items">
          ...
          <li class="main-nav__item parent-item">
            ...
            <ul class="sub-menu">
              <li class="sub-menu__item"><a href="<?php echo $linkMy?>artwork/" <?php if ($activeSubPage === "Artwork") { echo 'class="sub-menu__link sub-menu__link--current"'; }?> class="sub-menu__link">The Birley Art Project</a></li>
            </ul>
          </li><!-- My Birley ends -->
