...
<head>
  ...
  grunticon(["<?php echo $assets?>/css/icons.data.svg.css?v=5", "<?php echo $assets?>/css/icons.data.png.css?v=5", "<?php echo $assets?>/css/icons.fallback.css?v=5"]);

  </script>
  <noscript><link href="<?php echo $assets?>/css/icons.fallback.css?v=5" rel="stylesheet"></noscript>
