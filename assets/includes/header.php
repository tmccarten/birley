      ...
      <nav class="main-nav">
        <ul class="main-nav__items">
          ...
          <li class="main-nav__item">
            ...
            <a href="javascript:;" <?php if ($activePage === "Health") {echo 'class="main-nav__link main-nav__link--health current"'; } else echo 'class="main-nav__link main-nav__link--health"'; ?>>
              <svg class="parent-icon" xmlns="http://www.w3.org/2000/svg" width="10" height="14" viewBox="-197.4 107.8 460.8 378.5">
          ...
          <li class="main-nav__item parent-item">
            ...
            <a href="javascript:;" aria-hidden="true" <?php if ($activePage === "Archive") {echo 'class="main-nav__link main-nav__link--archive current parent"'; } else echo 'class="main-nav__link main-nav__link--archive parent"'; ?>>
              <svg class="parent-icon" xmlns="http://www.w3.org/2000/svg" width="10" height="14" viewBox="-197.4 107.8 460.8 378.5">
              <path class="st0" d="M258.7 244.5c-6.4-6.4-16.7-6.4-23 0L33.2 447.3l-202.8-202.8c-6.4-6.4-16.7-6.4-23 0-6.4 6.4-6.4 16.7 0 23l213.9 214c3.2 3.2 7.1 4.8 11.5 4.8 4 0 8.3-1.6 11.5-4.8l213.9-213.9c6.8-6.4 6.8-16.7.5-23.1z"/><style>.st0 {fill: #000;}</style>
              <path class="st0" d="M258.7 112.5c-6.4-6.4-16.7-6.4-23 0L33.2 315.3l-202.8-202.8c-6.4-6.4-16.7-6.4-23 0s-6.4 16.7 0 23l213.9 214c3.2 3.2 7.1 4.8 11.5 4.8 4 0 8.3-1.6 11.5-4.8l213.9-213.9c6.8-6.4 6.8-16.7.5-23.1z"/></svg></a>
            <ul class="sub-menu">
          ...
          <li class="main-nav__item parent-item">
            ...
            <a href="javascript:;" aria-hidden="true" <?php if ($activePage === "Grow") {echo 'class="main-nav__link main-nav__link--grow current parent"'; } else echo 'class="main-nav__link main-nav__link--grow parent"'; ?>>
              <svg class="parent-icon" xmlns="http://www.w3.org/2000/svg" width="10" height="14" viewBox="-197.4 107.8 460.8 378.5">
              <path class="st0" d="M258.7 244.5c-6.4-6.4-16.7-6.4-23 0L33.2 447.3l-202.8-202.8c-6.4-6.4-16.7-6.4-23 0-6.4 6.4-6.4 16.7 0 23l213.9 214c3.2 3.2 7.1 4.8 11.5 4.8 4 0 8.3-1.6 11.5-4.8l213.9-213.9c6.8-6.4 6.8-16.7.5-23.1z"/><style>.st0 {fill: #000;}</style>
              <path class="st0" d="M258.7 112.5c-6.4-6.4-16.7-6.4-23 0L33.2 315.3l-202.8-202.8c-6.4-6.4-16.7-6.4-23 0s-6.4 16.7 0 23l213.9 214c3.2 3.2 7.1 4.8 11.5 4.8 4 0 8.3-1.6 11.5-4.8l213.9-213.9c6.8-6.4 6.8-16.7.5-23.1z"/></svg></a>
            <ul class="sub-menu">
          ...
          <li class="main-nav__item">
            ...
            <a href="javascript:;" aria-hidden="true" <?php if ($activePage === "My") {echo 'class="main-nav__link main-nav__link--my current parent"'; } else echo 'class="main-nav__link main-nav__link--my parent"'; ?>>
              <svg class="parent-icon" xmlns="http://www.w3.org/2000/svg" width="10" height="14" viewBox="-197.4 107.8 460.8 378.5">
              <path class="st0" d="M258.7 244.5c-6.4-6.4-16.7-6.4-23 0L33.2 447.3l-202.8-202.8c-6.4-6.4-16.7-6.4-23 0-6.4 6.4-6.4 16.7 0 23l213.9 214c3.2 3.2 7.1 4.8 11.5 4.8 4 0 8.3-1.6 11.5-4.8l213.9-213.9c6.8-6.4 6.8-16.7.5-23.1z"/><style>.st0 {fill: #000;}</style>
              <path class="st0" d="M258.7 112.5c-6.4-6.4-16.7-6.4-23 0L33.2 315.3l-202.8-202.8c-6.4-6.4-16.7-6.4-23 0s-6.4 16.7 0 23l213.9 214c3.2 3.2 7.1 4.8 11.5 4.8 4 0 8.3-1.6 11.5-4.8l213.9-213.9c6.8-6.4 6.8-16.7.5-23.1z"/></svg></a>
          </li><!-- My Birley ends -->
