...
<head>
  ...
  <link href="<?php echo $assets?>/css/fonts.css?v=<?php $cssVersion?>" rel="stylesheet">
  ...
  grunticon(["<?php echo $assets?>/css/icons.data.svg.css?v=<?php $cssVersion?>", "<?php echo $assets?>/css/icons.data.png.css?v=<?php $cssVersion?>", "<?php echo $assets?>/css/icons.fallback.css?v=<?php $cssVersion?>"]);

  </script>
  <noscript><link href="<?php echo $assets?>/css/icons.fallback.css?v=<?php $cssVersion?>" rel="stylesheet"></noscript>
