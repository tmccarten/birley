  ...
  <section class="content">
    ...
    <section class="content-text">
      ...
      <div class="serif-text">
        <blockquote>‘once the demolition rubble had been removed, all that was left to recall the lives of thousands of people was the grid-like layout of the streets’
          <cite>(p.157, Sebald, The Emigrants, tr. Michael Hulse, London: Harvill, 1996)</cite>
        </blockquote>
        <p>For Sebald the trauma of destruction and rebuilding [of the Manchester terraced streets] gains the dimension of a natural disaster, and he observes that the anticipated ‘clean start’ is […] hampered by personal and collective history. Neil Scott’s ‘People of Hulme’, or Mary Jordan’s ‘Hulme Memories’, small local publications that seek to capture the rich and complicated history of lived working communities in industrial manufacturing Manchester echo this sense of loss.</p>

        <p>Now, on the Birley Site, the faint outline of the grid-like layout of the streets have been built upon again, with the optimism of a new generation and their envisaged futures.</p>
        ...
        Phase one: planned engagement in the run up to the design and the installation phase<br>
        Phase two: planned engagement after completion<br>
        Phase three: unplanned, organic engagement</p>

        <p>Phase one:
        Workshops with Hulme History Society and artist to understand life in the terraces and their dimensions and types; to gather stories, quotes, memories in order to design texts that will be powder coated into the surface of the frame.
        Workshops with students or schools to reflect on their understanding of housing then and now.
        ...
        <p>The lower levels of the frames may also become incidental play/climbing structures and consideration should be given to the ground below the structure.</p>
      </div>
