...
<main id="skipnav">
  ...
  <section class="content">
    ...
    <section class="content-text">
      ...
      <p>Between 2014 and 2016, artists from Manchester School of Art and Manchester School of Architecture developed concept designs to investigate themes of place, home, sustainability, permanence and transience, as related to the context of the site. Artist and Sculptor <a href="https://creativehandsfoundation.org/">Joseph Ayavoro</a> (Creative Hands Foundation) and poet <a href="http://www.applesandsnakes.org/page/84/Performance+poets/198">SuAndi</a> further added their experience to the exploration of these themes.</p>

      <ul class="content-text__list">
        <li class="content-text__list-item"><a href="research.php">Research</a></li>
        <li class="content-text__list-item"><a href="golden-terrace.php">Golden Terrace</a></li>
        <li class="content-text__list-item"><a href="where-the-wind-blows.php">Where the Wind Blows</a></li>
        <li class="content-text__list-item"><a href="thresholds.php">Thresholds</a></li>
        <li class="content-text__list-item"><a href="terrace-seating.php">Terrace Seating</a></li>
        <li class="content-text__list-item"><a href="the-bees.php">The Bees</a></li>
        <li class="content-text__list-item"><a href="stories-from-the-hearth/">Stories From The Hearth</a></li>
      </ul>
    </section>
